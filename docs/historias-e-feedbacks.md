# 💬 Histórias e feedbacks

O que ninguém conta no manual: como foi *de verdade* começar na UFSC. Esta página
reúne relatos de veteranos — o que ajudou, o que atrapalhou, o que fariam
diferente. É o coração humano do portal.
...
Copie o bloco abaixo para adicionar a sua:

```markdown
### <Título curto da história>
- **Curso / ano de ingresso:** 
- **Autoria:** (nome, apelido ou anônimo)

<Seu relato: o que te pegou de surpresa, o que te ajudou, um conselho.>
```
...
> _Ainda não há histórias publicadas. Seja o primeiro a compartilhar!_

<!-- As histórias enviadas entram aqui. -->
