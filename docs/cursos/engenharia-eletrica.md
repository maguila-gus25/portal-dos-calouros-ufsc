...
turno: Diurno
coordenacao:
  email: eletrica@contato.ufsc.br
...
## Vida do curso
- **Centro Acadêmico:** **CAEEL** (Centro Acadêmico das Eng. Elétrica e Eletrônica) — [@caeel.ufsc](https://www.instagram.com/caeel.ufsc/)
- **Atlética:** **Ateel** — [@ateelufsc](https://www.instagram.com/ateelufsc/) (compartilhada com Engenharia Eletrônica)
- **Empresa júnior:** **C2E** — Empresa Júnior de Consultoria em Engenharia Elétrica
...
## Onde estudar / salas
- _A preencher_ (laboratórios, salas de estudo do EEL — ver [Mapa](../mapa.md)).
