...
- **Coordenação:** <https://geltro.ufsc.br/coordenacao/>

(ver também [Coordenações](../coordenacoes.md))

## Vida do curso
- **Centro Acadêmico:** **CAEEL** (Centro Acadêmico das Eng. Elétrica e Eletrônica) — [@caeel.ufsc](https://www.instagram.com/caeel.ufsc/) (CA compartilhado com Eng. Elétrica)
- **Atlética:** **Ateel** — [@ateelufsc](https://www.instagram.com/ateelufsc/) (compartilhada com Engenharia Elétrica)
