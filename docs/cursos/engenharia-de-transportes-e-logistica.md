---
curso: Engenharia de Transportes e Logística
slug: engenharia-de-transportes-e-logistica
centro: CTJ
grau: Bacharelado
turno: Integral
...
> **Campus Joinville** — Rua Dona Francisca, 8300 – Bloco U – Zona Industrial Norte, Joinville, SC.

## Sobre o curso

- **Grau / turno:** Bacharelado — turno **Integral**
- **Duração:** 10 semestres (5 anos)
- **Vagas:** 25 por semestre (15 via SiSU)
- **Página oficial do curso:** <https://transporteslogistica.joinville.ufsc.br/>
- **Guia de Cursos UFSC:** <https://guiadecursos.ufsc.br/campus-joinville/>
- **Resumo:** Forma engenheiros para planejar, projetar e gerir sistemas de transporte e cadeias logísticas. O currículo abrange modais rodoviário, ferroviário, aquaviário e aéreo, além de planejamento urbano, otimização de rotas, gestão de frotas, automação logística e sustentabilidade em transportes.

## Coordenação

- **Coordenadora:** Renata Cavion
  - Telefone: (48) 3721-6261
  - E-mail: _A preencher_ — exibido como imagem no site; verificar em <https://transporteslogistica.joinville.ufsc.br/en/gestao-do-curso/>
  - Sala: _A preencher_ — verificar em <https://transporteslogistica.joinville.ufsc.br/en/gestao-do-curso/>
- **Vice-Coordenadora:** Simone Becker Lopes
  - E-mail: _A preencher_
  - Sala: _A preencher_
- **Secretaria Acadêmica (geral):** (48) 3721-7331 · (48) 3721-2643

(ver também a ficha do centro [CTJ](../centros/ctj.md))
...
_A preencher_ — Bloco U, Campus Joinville (ver [Mapa](../mapa.md))
