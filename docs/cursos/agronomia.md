...
coordenacao:
  ...
  email: ~
  telefone: "(48) 3721-5411"
  sala: ~
  atendimento: ~
  site: https://agronomia.ufsc.br/
atletica: ATAG — @atag.ufsc
instagram_curso: "@caagroufsc"
...
- **Resumo:** Forma Engenheiros Agrônomos com sólida base técnico-científica e responsabilidade social, atuando em produção agrícola, preservação ambiental e gestão rural. O currículo inclui estágios obrigatórios no 4º e no 10º semestres.

## Coordenação

- **Coordenador:** Prof. Tiago Olivoto
...
- **Instagrams / perfis:**
  ...
  - [@agronomiaccaufsc](https://www.instagram.com/agronomiaccaufsc/) — perfil do curso
...
- _A preencher_ (laboratórios e salas de estudo do curso no campus Itacorubi — ver [Mapa](../mapa.md)).
