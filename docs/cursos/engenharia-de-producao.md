...
> [producaocem](https://producaocem.paginas.ufsc.br/).
...
- **Atendimento:** Seg–Sex, 08h–12h e 13h–17h (confirmar no site)
- **Coordenação:** <https://producao.ufsc.br/objetivos-do-curso/coordenacao/>
...
## Onde estudar / salas
- _A preencher_ (laboratórios, salas de estudo do EPS — ver [Mapa](../mapa.md)).
