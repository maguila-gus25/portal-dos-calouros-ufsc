...
slug: engenharia-de-materiais
centro: CTC
grau: Bacharelado
turno: Diurno
coordenacao:
  email: materiais@contato.ufsc.br
...
- **Duração:** 5 anos (currículo cooperativo, com estágio obrigatório em empresas)
- **Página oficial do curso:** <https://materiais.grad.ufsc.br/>
- **Resumo:** Desenvolvimento e caracterização de materiais metálicos, cerâmicos, poliméricos e compósitos.
...
- **Fale conosco:** <https://materiais.grad.ufsc.br/?page_id=108>
...
## Onde estudar / salas
- _A preencher_ (laboratórios, salas de estudo — ver [Mapa](../mapa.md)).
