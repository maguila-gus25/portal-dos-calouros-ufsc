# Conteúdo do Portal dos Calouros — CTC

Índice de tudo o que o calouro do **Centro Tecnológico (CTC)** precisa saber.
Comece pelo tema que te interessa:

## Guias essenciais
- 🏛️ [Coordenações dos cursos](coordenacoes.md) — nome, e-mail, telefone e sala
- 🍽️ [Carteira do RU](carteira-ru.md) — como se cadastrar e comer no Restaurante Universitário
...
- `_A preencher_` → informação ainda não confirmada com fonte oficial. Se você
  souber (com fonte!), abra um Pull Request. Veja [como contribuir](../CONTRIBUTING.md).
