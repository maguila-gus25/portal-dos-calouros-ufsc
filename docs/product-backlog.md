...
| B-61 | 🟠 Should | 🔴 G | 🚧 | Como **calouro**, quero **fichas dos cursos de todos os centros da UFSC Florianópolis**, para **ter informações do meu curso independente do centro**. Seguir o mesmo modelo de `docs/cursos/<slug>.md` já usado no CTC. **Sprint 14:** 4 fichas do CCA. **Sprint 16:** 5 fichas do CSE. **Sprint 18:** 6 fichas do CCS (Enfermagem, Farmácia, Fonoaudiologia, Medicina, Nutrição, Odontologia) — reaproveitando `docs/centros/ccs.md`; incertos como `_A preencher_`. Faltam: cursos do CCE (9) e demais centros. |
