...
| B-74 | 🟠 Should | 🟢 P | 🚧 | Como **calouro**, quero **conhecer ferramentas da comunidade** (MyFUFSC, MatrUFSC) que facilitam a vida acadêmica, para **usá-las desde a chegada**. (issue #47) **Sprint 17:** seção "Ferramentas da comunidade" em `docs/links-importantes.md`; **MatrUFSC** publicado (`matrufsc.github.io`); **MyFUFSC** `_A preencher_` (não confirmado — aguarda mantenedor definir o app/link exato). |
